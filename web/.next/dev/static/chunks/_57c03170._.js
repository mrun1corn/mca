...
function LoginForm() {
    ...
    const handleSubmit = async (event)=>{
        ...
        setLoading(true);
        try {
            const res = await fetch(`${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBrowserApiBase"])()}/auth/login`, {
                method: "POST",
                headers: {
...
_s(LoginForm, "yjaJBFy+5MQHvy3fA09tJXO2sZ8=", false, function() {
    return [
...
//# sourceMappingURL=_57c03170._.js.map